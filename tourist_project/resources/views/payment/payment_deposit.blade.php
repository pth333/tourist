            ...
            <div class="row g-3 tour-container justify-content-center payment-container">
                ...
                <div class="col-lg-5 payment-form">
                    <div class="booking-form">
                        <form action="{{ route('payment.deposit', ['orderId' => $dataAll['orderId']]) }}" method="POST" class="d-grid gap-2">
                            @csrf
                            <h3>Thông tin thanh toán</h3>
                            <div class="form-group">
                                <label for="amount">Tổng giá tiền:</label>
                                <input type="text" value="{{ number_format($dataAll['total_price'])}}" class="form-control" id="amount" name="amount" readonly>
                            </div>
                            <div class="form-group">
                                <label for="amount_per">Tổng số người:</label>
                                <input type="number" value="{{ $dataAll['total_person']}}" class="form-control" id="amount_per" name="amount_per" readonly>
                            </div>
                            <div class="form-group">
