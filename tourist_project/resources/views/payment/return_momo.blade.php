                ...
                <div class="col-lg-5" style="background-color: #f5f5f5; padding:30px; border-radius:5px;">
                    ...
                    <div class="booking-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $momoData['orderId'] }}" class="form-control" id="p_price" readonly>
                        </div>
                        <div class="form-group">
                            <label for="p_price">Giá tiền:</label>
                            <input type="text" value="{{ number_format($momoData['amount'])}} VNĐ" class="form-control" id="p_price" readonly>
                        </div>
                        <div class="form-group">
                            <label for="p_code_vnpay">Mã giao dịch MOMO:</label>
                            <input type="text" value="{{ $momoData['transId'] }}" class="form-control" id="p_code_vnpay" readonly>
                        </div>
                        <div class="form-group">
                            <label for="p_code_bank">Trạng thái giao dịch:</label>
                            <input type="text" value="{{ $momoData['message'] }}" class="form-control" id="p_code_bank" readonly>
                        </div>
                        <div class="form-group">
                            <label for="p_note">Ghi chú:</label>
                            <textarea class="form-control" id="p_note" rows="3" readonly>{{ $momoData['orderInfo'] }}</textarea>
                        </div>
