            ...
            <div class="modal-body">
                <form action="{{ route('destination.store')}}" id="add-blog-form" name="add-blog-form" class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('name_des') is-invalid @enderror" id="name" name="name_des" value="{{ old('name')}}" placeholder="Nhập tên địa điểm"  >
                            @error('name_des')
                    ...
                    <div class="form-group">
                        <label for="ticket_price" class="col-sm-2 control-label">Giá vé vào</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('ticket_price') is-invalid @enderror" id="ticket_price" name="ticket_price" value="{{ old('ticket_price')}}" placeholder="Nhập giá vé"  >
                            @error('ticket_price')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control @error('open_time') is-invalid @enderror" id="open_time" name="open_time" value="{{ old('open_time')}}" placeholder="Nhập giờ mở cửa"  >
                                    @error('open_time')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control @error('close_time') is-invalid @enderror" id="close_time" name="close_time" value="{{ old('close_time')}}" placeholder="Nhập giờ đóng cửa"  >
                                    @error('close_time')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude')}}" placeholder="Nhập vĩ độ"  >
                                    @error('latitude')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control @error('longtitude') is-invalid @enderror" id="longtitude" name="longtitude" value="{{ old('longtitude')}}" placeholder="Nhập kinh độ"  >
                                    @error('longtitude')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
